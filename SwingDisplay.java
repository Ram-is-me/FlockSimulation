...
class SwingDisplay implements FlockDisplay {
	...
	private int flockToggle = 1;  //Setting a Target for a particular flock
	...
	private void setupGUI() {
		...
		canvas.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				app.setTarget(e.getX(), e.getY(), flockToggle);
			}
		});
		...
		gframe.add(b0, BorderLayout.NORTH);
		...
		gframe.add(b1, BorderLayout.EAST);
		...
		gframe.add(b2, BorderLayout.WEST);
		...
		JButton b3 = new JButton("Target");
		gframe.add(b3, BorderLayout.CENTER);
		...
		gframe.add(b5, BorderLayout.SOUTH);
